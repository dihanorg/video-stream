...
async def gen_thumb(thumbnail, title, userid, ctitle):
    ...
    image2 = Image.open(f"driver/helpers/other/choose/rrc.png")
    ...
    font = ImageFont.truetype("driver/helpers/other/choose/Roboto-Light.ttf", 55)
    font2 = ImageFont.truetype("driver/helpers/other/choose/finalfont.ttf", 65)
    draw.text(
        (20, 630),
        f"{title[:25]}...",
        fill="White",
