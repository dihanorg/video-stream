...
@Client.on_message(command(["oosong", f"oosong@{bn}"]) & ~filters.edited)
def song(_, message):
...
@Client.on_message(
    command(["avsong", f"avsong@{bn}", "avideo", f"avideo@{bn}"]) & ~filters.edited
)
...
@Client.on_message(command(["alyric", f"alyric@{bn}"]))
